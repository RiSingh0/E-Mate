<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $myusernames = hash('sha1', $myusername,'TRUE');
      $mypassword = mysqli_real_escape_string($conn,$_POST['password']); 
      $mypasswords = hash('sha1', $mypassword,'TRUE');
...
<body>
    ...
    <div class="banner">
        ...
        <header>
            ...
            <h1><a class="navbar-brand" href="index.php">Women Empowerment
        ...
        <div class="container">
            ...
            <div class="banner-text">
                      <div class="slider-info container"> <div class="form-group text-center">
