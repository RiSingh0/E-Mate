<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT * FROM teacherstbl WHERE te_username = '$myusernames' and te_password = '$mypasswords'";
      $result = mysqli_query($con,$sql);
      error_reporting(0);
      $row = mysqli_fetch_array($result,MYSQLI_ASSOC);
      $count = mysqli_num_rows($result);
      if($count == 1) {$_SESSION['login_user']=$row['te_username'];
          $_SESSION['full_name'] = $row['te_fullname'];  
            ...
            <div class="banner-text">
               ...
               <div class="form-group text-center">
                  ...
                  <form action = "" method = "post">
                     ...
                     <div class="form-group">
                        <input type="submit" name="" id="" class="btn btn-success" value="Login" />
                     </div>
                  </form>
               </div>
            </div>
