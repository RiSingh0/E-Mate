...
if (@session_status() == PHP_SESSION_NONE) {
  @session_start();
                ...
                while( $resultArray = mysqli_fetch_array($result))
                {
                  ...
                  $name=$resultArray['st_name'];
                  $sub1=$resultArray['sub1'];$sub2=$resultArray['sub2'];$sub3=$resultArray['sub3']; $sub4=$resultArray['sub4']; $sub5=$resultArray['sub5']; $sub6=$resultArray['sub6'];
                $user_arr[] = array($st_id1,$sub1,$sub2,$sub3,$sub4,$sub5,$sub6,$name);}
                 if (isset($_POST["save"])) { $filename = 'pt2result.csv';
...
<div class="padding-1">
              ...
              <div class="box-body">
              <br><br><a class=' btn btn-warning float-right'  href='te_pt2.php'>< &emsp; Back</a>
                ...
                <?php        
                  ...
                  $sub1=$resultArray['sub1'];$sub2=$resultArray['sub2'];$sub3=$resultArray['sub3']; $sub4=$resultArray['sub4']; $sub5=$resultArray['sub5']; $sub6=$resultArray['sub6'];
                  echo  "<tr><td><label name='result' >Roll no &emsp; : $st_id1 &emsp;|&emsp; Name &emsp; : $name1 &emsp;|&emsp;1st Subject : $sub1 &emsp;|&emsp;2nd Subject : $sub2 &emsp;|&emsp;3rd Subject : $sub3&emsp;|&emsp;4th Subject : $sub4&emsp;|&emsp;5th Subject : $sub5&emsp;&emsp;|&emsp;6th Subject : $sub6</label></td></tr>"; 
                }
                echo " </table><button type='submit' class='link btn btn-primary' name='save' id='save'>↓&emsp;Save</button>";
                }
                else{
