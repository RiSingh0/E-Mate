...
<div class="col-md-12">
  <div class="padding row">      
    <div class="col-md-6">
      <label>Channel</label>
      <select class="form-control select2" id="dd_channel">
    ...
    <div class="col-md-6">
      <div class="form-group">
        ...
        <select class="form-control select2"  id="dd_sem">
          <option value="0">Select</option>
          ...
          <option value="6">6</option>              
             ...
             <div class="padding">
              <h4 style="margin-bottom: 10px;">Uploaded Notes</h4>
              <div class="box-body">
            ...
            <div class="padding-1">
              <h4 style="margin-bottom: 10px;">Marks Entered</h4>
              <div class="box-body">
            ...
            <div class="padding-1">
              <h4 style="margin-bottom: 10px;">Ranking</h4>
              <div class="box-body">
