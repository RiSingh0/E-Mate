            ...
            <div class="padding-1">
              ...
              <div class="box-body">
                ...
                <?php        
                  ...
                  $sql="SELECT * from mcq_result where st_id='$st_id'";
                  $result = mysqli_query($conn,$sql) or die("Error: " . mysqli_error($conn));
                  
                  while( $resultArray = mysqli_fetch_array($result))
                  {
                  
                  $marks=$resultArray['tot_marks'];$OutOff=$resultArray['out_off'];
                  echo  "<tr><td><label name='result1' >Roll no &emsp;&emsp;:&emsp;&emsp;&emsp;&emsp;$st_id</label></td></tr>"; 
                  echo  "<tr><td><label name='result1' >Name &emsp;&emsp;: &emsp;&emsp;&emsp;&emsp; $name</label></td></tr>";
                  echo  "<tr><td><label name='result1' >Marks &emsp;&emsp;:&emsp;&emsp;&emsp;&emsp;$marks</label></td></tr>";
                  echo  "<tr><td><label name='result1' >OutOff &emsp;&emsp;:&emsp;&emsp;&emsp;&emsp;$OutOff</label></td></tr>";
                  }
