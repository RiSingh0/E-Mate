...
<div class="padding-1">
              ...
              <div class="box-body">
                <br><br><br>
                <h4 style="margin-bottom: 10px;">PT 2 &emsp;Result :</h4>
                <?php        
                ...
                while($resultArray = mysqli_fetch_array($result))
                {
                  ...
                  $check=mysqli_query($conn,"SELECT * from pt2 where st_id='$st_id' or st_name='$name'"); 
                 
                  if($check=mysqli_query($conn,"SELECT * from pt2 where st_id='$st_id' or st_name='$name'"))
                  {
                  $checkrows=mysqli_num_rows($check);}else{$checkrows=0;}
                  if($checkrows<1)
                  {
                  $sql=" INSERT INTO pt2 (st_id,st_name)
                  VALUES ('$st_id','$name')";
                  ...
                  $sql="SELECT * from pt2 ORDER BY st_id ASC";
                  $result = mysqli_query($conn,$sql) or die("Error: " . mysqli_error($conn));
                  ...
                  echo " </table><button type='submit' class='link btn btn-primary' name='save' id='save'>Update</button> <a  class='link btn btn-primary' href='pt2_result.php'>PT 2 RESULT</a>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
?>
    ...
    { 
       for($j=0;$j<$k;$j++)
       {
        ...
        $sub6 = $_POST['sub6'][$j];
        $st_id = $_POST['st_id'][$j];
        $sql="UPDATE pt2 SET sub1 = '$sub1',sub2 = '$sub2',sub3 = '$sub3',sub4='$sub4',sub5='$sub5', sub6='$sub6' WHERE st_id = '$st_id'";
        if (mysqli_query($conn,$sql))
        {
