...
$_SESSION['LAST_ACTIVITY'] = $time;
 $servername="localhost";
                  ...
                  $sql="SELECT * from mcq_result ORDER BY st_id ASC";
                  $result = mysqli_query($conn,$sql) or die("Error: " . mysqli_error($conn));
                  while( $resultArray = mysqli_fetch_array($result))
                  {
                  $st_id=$resultArray['st_id'];
                  $marks=$resultArray['tot_marks'];
                  $name=$resultArray['sname'];
                  $out_off=$resultArray['out_off'];
                  $user_arr[] = array($st_id,$name,$marks,$out_off);}
                   if (isset($_POST["save"])) { $filename = 'result.csv';
...
<div class="padding-1">
              ...
              <div class="box-body">
                ...
                <?php        
                  ...
                  $name=$resultArray['sname'];
                  $out_off=$resultArray['out_off'];
                  echo  "<tr><td><label name='result' >Roll no &emsp;&emsp; :  $st_id &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;|&emsp;&emsp;&emsp;&emsp; Name &emsp;&emsp; : $name &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;|&emsp;&emsp;&emsp;&emsp; Marks &emsp;&emsp; :  $marks&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;|&emsp;&emsp;&emsp;&emsp; OutOff &emsp;&emsp; :  $out_off</label></td></tr>"; 
                  }
