...
<head>
    <title>Student Teacher Portal | Index</title>
        ...
        <div class="container">
            ...
            <div class="banner-text">
                <div class="slider-info">
                    <h3>WELCOME To <span>STUDENT TEACHER </span>PORTAL</h3>
					...
					<br>
					<input type="button" class="btn btn-success btn-primary" id="btn_login" name="btn_login" value="Login" />
				</div>
            </div>
        </div>
    </div>
